...
pub const regressions = [_]RegressionEntry{
    ...
    .{ .name = "Regressions/IntegerMemoryRegions.sx", .concern = "integer loop regions across class and collection memory preserve cold exits, aliases, empty and negative iteration counts" },
