...
bins={name:root/filename for name,filename in [('before','branch-wide-before'),('shared','branch-wide-shared'),('after','branch-wide-after')]}
def run(name):
