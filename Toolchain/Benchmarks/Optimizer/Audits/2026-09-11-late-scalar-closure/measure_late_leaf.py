...
bins={name:root/filename for name,filename in [('before','late-leaf-baseline'),('shared','late-leaf-control'),('after','late-leaf-final')]}
def run(name):
