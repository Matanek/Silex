...
; Function Attrs: cold minsize noreturn nounwind memory(inaccessiblemem: write)
define noundef i64 @sx_1(i64 %v0, i64 %v1) local_unnamed_addr #3 {
b0:
  tail call void @llvm.trap()
  unreachable
}
...
define range(i64 -9223372036854775795, -9223372036854775808) i64 @sx_2(i64 %v0, i64 %v1) local_unnamed_addr #4 {
b0:
...
; Function Attrs: cold minsize noreturn nounwind memory(inaccessiblemem: write)
define noundef i64 @sx_3() local_unnamed_addr #3 {
b0:
  tail call void @llvm.trap()
  unreachable
}
...
define double @sx_4(double %v0) local_unnamed_addr #5 {
b0:
...
define void @sx_5(%sx.type.0 %v0) local_unnamed_addr #6 {
b0:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define noundef range(i64 -9223372036854775800, -9223372036854775808) i64 @sx_6() local_unnamed_addr #5 {
b0:
  ret i64 42
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define range(i64 5, 22) i64 @sx_7(i1 %v0) local_unnamed_addr #5 {
b0:
...
; Function Attrs: cold minsize noreturn nounwind memory(inaccessiblemem: write)
define void @sx_8() local_unnamed_addr #3 {
b0:
  tail call void @llvm.trap()
  unreachable
}
...
attributes #3 = { cold minsize noreturn nounwind memory(inaccessiblemem: write) }
attributes #4 = { nounwind memory(inaccessiblemem: write) }
attributes #5 = { mustprogress nofree norecurse nosync nounwind willreturn memory(none) }
attributes #6 = { nounwind memory(write) }
