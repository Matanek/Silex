...
names=('before','partial','after')
bins={name:root/filename for name,filename in [('before','preparation-before-residence'),('partial','preparation-partial-residence'),('after','preparation-direct-residence')]}
def run(name):
...
for i in range(21):
 ...
 row['after_partial']=row['after_ns']/row['partial_ns']
 rows.append(row)
summary={}
for key in ('before_ns','partial_ns','after_ns','after_before','after_partial'):
