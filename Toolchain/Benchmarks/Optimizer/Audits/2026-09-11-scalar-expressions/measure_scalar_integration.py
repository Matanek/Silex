...
bins={name:root/filename for name,filename in [('before','integration-repeated-long'),('shared','integration-shared-long'),('after','integration-cse-long')]}
def run(name):
