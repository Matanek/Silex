...
/private/tmp/silex-part03-evidence/gpr-exhaustive-objects-macos-x64:	file format mach-o 64-bit x86-64
...
1000016cd: 48 8d 15 04 4a 00 00        	leaq	0x4a04(%rip), %rdx      ## 0x1000060d8
