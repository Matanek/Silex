...
pub const object_bytes = @import("deep_copy_runtime_x64_object").object_bytes;
pub const macos_object_bytes = @import("deep_copy_runtime_macos_x64_object").object_bytes;
...
test "bundled X64 deep-copy runtime is an ELF image" {
...
test "bundled macOS X64 deep-copy runtime is a Mach-O image" {
