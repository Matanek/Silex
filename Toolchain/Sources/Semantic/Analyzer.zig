...
pub const Analyzer = struct {
    ...
    pub const mutexStatement = Statements.mutexStatement;
    ...
    pub const validateIsolatedFunctionByName = Validation.validateIsolatedFunctionByName;
    ...
    pub const validateIsolatedProtocolMethodByName = Validation.validateIsolatedProtocolMethodByName;
    pub const validateIsolatedStructureLifecycle = Validation.validateIsolatedStructureLifecycle;
