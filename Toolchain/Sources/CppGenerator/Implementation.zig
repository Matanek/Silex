...
pub const Generator = struct {
    ...
    pub const generateNativeGenericFunctionSignature = Protocols.generateNativeGenericFunctionSignature;
    ...
    pub const nativeIsolatedCallbackIndex = NativeTransports.nativeIsolatedCallbackIndex;
    ...
    pub const generateNativeGenericFunctionCall = NativeCalls.generateNativeGenericFunctionCall;
