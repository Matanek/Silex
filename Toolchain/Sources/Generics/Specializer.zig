...
const InferredLocal = Types.InferredLocal;
...
pub const Specializer = struct {
    ...
    inferred_locals: std.ArrayList(InferredLocal) = .empty,
    inference_frame_start: usize = 0,
    inference_self_type: ?Ast.TypeName = null,
    ...
    pub const instantiateStaticMethods = Instantiate.instantiateStaticMethods;
    pub const genericMethodRequiresArguments = Instantiate.genericMethodRequiresArguments;
    ...
    pub const beginInferenceCallable = Inference.beginInferenceCallable;
    pub const endInferenceCallable = Inference.endInferenceCallable;
    pub const addInferredLocal = Inference.addInferredLocal;
    pub const inferredLocalType = Inference.inferredLocalType;
    pub const inferExpressionType = Inference.inferExpressionType;
    pub const inferFunctionCall = Inference.inferFunctionCall;
    pub const inferMethodCall = Inference.inferMethodCall;
    pub const inferStaticMethodCall = Inference.inferStaticMethodCall;
    pub const typeNamesEqual = Inference.typeNamesEqual;
