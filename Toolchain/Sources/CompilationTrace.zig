...
pub const Phase = enum(u8) {
    ...
    semantic_validation,
    semantic_source_functions,
    semantic_generated_functions,
    semantic_constructors,
    semantic_methods,
    semantic_drops,
    semantic_class_fields,
    semantic_bound_methods,
    semantic_finalization,
    package_cache_read,
    package_cache_relocation,
    package_cache_write,
    cache_update,
    program_closure,
    optimization,
...
pub const Metrics = struct {
    ...
    llvm_units_reused: usize = 0,
    llvm_units_compiled: usize = 0,
    llvm_functions_reused: usize = 0,
    range_functions_reused: usize = 0,
    range_functions_computed: usize = 0,
